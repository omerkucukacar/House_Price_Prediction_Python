    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h4 class="pt-3"> Your Purchase Property ID: {{orderID}}</h4>
            </div>
        </div>
            ...
            <div class="col-md-5 px-3">
                <div class="card-block px-3">
                    ...
                    <p id="item-total-price" class="mb-0">
                        Nr of Tokens to Purchase : <span class="font-weight-bold">{{ orderItem.price * orderItem.quantity}}</span>
                    </p>
                </div>
            </div>
            <div class="col-md-5 px-3">
                <div class="card-block px-3">
                    ...
                    <p id="item-quantity" class="mb-0">Quantity : {{orderItem.quantity}}</p>
                    <p id="item-total-price" class="mb-0">
                        Price Investment : $<span class="font-weight-bold">{{ orderItem.price * orderItem.quantity}}</span>
                    </p>
                </div>
            </div>
            <div class="col-1"></div>
