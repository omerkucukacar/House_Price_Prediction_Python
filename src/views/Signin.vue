      ...
      <div class="col-12 justify-content-center d-flex flex-row pt-5">
        <div id="signin-div" class="flex-item border">
          ...
          <form @submit="signin" class="pt-4 pl-4 pr-4">
            ...
            <br>
            <p a href="C:\Users\ben\Desktop\RealEstate-master\ecommerce-vuejs-master\src\views\forgotpassword.vue">Forgot Password?</p>
            <br>

            <small class="form-text text-muted"
              >By continuing, you agree to RealState's Conditions of Use and
