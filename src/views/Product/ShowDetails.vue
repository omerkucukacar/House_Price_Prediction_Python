        ...
        <div class="d-flex flex-row justify-content-between">
          <div class="input-group col-md-3 col-4 p-0">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">Quantity for Tokens</span>
            </div>
...
export default {
  data() {
    return {
      ...
      wishlistString: "Add to Property",
      quantity: 1,
    };
  },
        ...
        .then(
          (response) => {
            if (response.status == 201) {
              ...
              this.wishlistString = "Added to Property";
            }
          },
          (error) => {
            console.log(error);
      ...
      axios
        ...
        .then(
          (response) => {
            if (response.status == 201) {
              swal({
                text: "Tokens Added to the Purchase!",
                icon: "success",
